...
<body>
  <!--Navbar-->
  <header >
  <nav class="navbar fixed-top navbar-bg  nav-masthead navbar-expand-lg navbar-dark p-md-1">
            <div class="container">
                <a href="#" class="navbar-brand"><img src="./Images/Eventos/LOGO.png" height="60px" width="60px" alt="Logo" /></a>
        <button
        ...
        <div class="row">
            <div class="col-12">
                ...
                <select id="entidad" name="entidad" onchange="cargarMunicipios()" required>
                    <option value="update"><?php echo $datosCliente->EntidadFederativa; ?></option>
...
<fieldset>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <select id="tipo" name="tipo" onchange="mostrarCampoEvento() && activarCampoOtro()" required>
                <option value="update"><?php echo $datos->TipoEvento; ?></option>
        ...
        <div class="row">
          <div class="col-12">
              ...
              <select id="salon" name="salon" onchange="checkSelection('salon')" required>
                <option value="update"><?php echo $datos->SalonSeleccionado; ?></option>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <select id="menu" name="menu" onchange="checkSelection('menu')" required>
                <option value="update"><?php echo $datos->MenuSeleccionado; ?></option>
        ...
        <div class="row">
          <div class="col-12">
              ...
              <select value="<?php echo $datos->Horario; ?>" id="horaEvento" name="horaEvento" required>
                  <option value="update"><?php echo $datos->Horario; ?></option>
    ...
    <button type="submit" class="btn btn-outline-light" id="registrar" style="font-weight: bold;">Actualizar</button>
